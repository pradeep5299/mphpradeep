...
con = MyDBConnection.getDBConnection();
		...
		try {
			st = con.createStatement();
			st.addBatch("update mphemp set ename ='Mohann' where eid=877");
			st.addBatch("update mphemp set eid=13 where ename ='sam'");
			st.addBatch("update mphemp set ename ='Varunaa' where eid=112");
			st.addBatch("update mphemp set ename ='Sarikaa' where eid=10");
			st.addBatch("update mphemp set ename ='Rajaa' where eid=900");
